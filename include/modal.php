...
if (isset($_POST['tp']) && $_POST['tp'] == 'add-jurusan') {
?>
...
<?php } else if (isset($_POST['tp']) && $_POST['tp'] == 'edit-jurusan') {
    $idjur = $_POST['id'];
?>
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
...
<?php } else if (isset($_POST['tp']) && $_POST['tp'] == 'delete-jurusan') {
    $idjur = $_POST['id'];
?>
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
...
<?php } else { ?>
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Pop Modal</h4>
            </div>
            <div class="modal-body">
                <p>Modal sedang dalam proses pengembangan</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"> <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Close</button>
            </div>
