...
<head>
    ...
    <title>REPORT SYS | IM SOLUSI</title>
        ...
        <div class="login-box-body">
            ...
            <form id="loginForm">
                ...
                <div class="row">
                    ...
                    <!-- /.col -->
                    <div class="col-xs-4">
                        <button type="button" onclick="actLogin();" class="btn btn-primary btn-block btn-flat">Sign In</button>
                    </div>
                    <!-- /.col -->
                </div>
            </form>
